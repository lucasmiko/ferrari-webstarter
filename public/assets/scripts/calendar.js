import { addDays, addMonths, differenceInSeconds, endOfMonth, endOfWeek, format, startOfWeek, subMonths } from "date-fns";
...
document.querySelectorAll("#schedules-new").forEach(page => {
  ...
  form.addEventListener('submit', e => {
    if (!page.querySelector('[name=schedules_at]').value) {
      button.disabled = true;
      e.preventDefault()
    }
  })
